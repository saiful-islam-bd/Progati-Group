...
$id = $_GET['id'];
$sql = "SELECT * FROM cover_Image where id=$id";
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Edit: Company Cover Image</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="companyCoverImage_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
