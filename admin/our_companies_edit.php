            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Edit: Our Companies</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="our_companies_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="summernote" value="<?php echo $description ?>" name="description"><?php echo $description ?></textarea>
                                </div>
                            </div>
