...
$id = $_GET['id'];
$sql = "SELECT * FROM  video_gallery_category where id=$id";
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Edit: Video Gallery Category</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="videoGallery_category_update.php?id=<?php echo $id ?>" method="post">
