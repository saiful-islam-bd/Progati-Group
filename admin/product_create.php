                    ...
                    <form action="product_store.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Product Name" value="" name="product_name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Company Name</strong></label>
                                <div class="col-sm-9">
