            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Form: At A Glance</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="glance_store.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" step="any" min="0" class="form-control" placeholder="Number" value="" name="number" required>
                                </div>
                            </div>
