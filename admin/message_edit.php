        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <!-- ############################## Form ############################## -->
                    <form action="message_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Who's Message</strong></label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Who's Message" value="<?php echo $whos_message ?>" name="whos_message" required>
                                </div>
                            </div>
