...
$id = $_GET['id'];
$sql = "SELECT * FROM product_banner where id=$id";
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4>Edit: Product Banner</h4>
                    </div>


                    <!-- ############################## Form ############################## -->
                    <form action="product_banner_update.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data">
